 ...
 *
 * @package   SC101_Template_Loader1
 * @author    Gary Jones
...
if ( ! class_exists( 'SC101_Template_Loader1' ) )  {
	/**
	 * Template loader.
	 *
	...
	class SC101_Template_Loader1 {
		 ...
		 * @type string
		 */
		protected $plugin_directory = ABSPATH . 'wp-content/plugins/wdv-ajax-search/';
		 ...
		 * @since 1.0.0
		 *
		 * @uses SC101_Template_Loader1::get_template_possble_parts() Create file names of templates.
		 * @uses SC101_Template_Loader1::locate_template() Retrieve the name of the highest priority template
		 *     file that exists.
		 *
		 * @param string  $slug
